...
echo "args: $*" >>${ARMLOGPATH}
echo 'Inititalized variables, ' $REPO_USER, $REPO_PASSWORD, $VHOST_ALIAS, $EDGE_VERSION, $DEPLOYMENT_TOPOLOGY, $LB_IP_ALIAS, "Hosts: " $HOST_NAMES  >>${ARMLOGPATH}
